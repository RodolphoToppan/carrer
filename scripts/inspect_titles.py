...
tech_keywords = {
    'spring': 0, 'rabbitmq': 0, 'activemq': 0, 'artemis': 0,
    'postgres': 0, 'postgresql': 0, 'oracle': 0,
    'docker': 0, 'kubernetes': 0, 'k8s': 0,
    'sql': 0, 'api': 0, 'rest': 0, 'grpc': 0,
    'microservice': 0, 'marketplace': 0, 'integration': 0
}
